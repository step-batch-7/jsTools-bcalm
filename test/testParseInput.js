...
describe("#parseInput", () => {
  it("should give a object which includes all options as key and their values also", () => {
...
describe("#getOptions", () => {
  ...
  it("should not make pair of given element if last element is not an array", () => {
